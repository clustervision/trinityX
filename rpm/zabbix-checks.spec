...
Source0:	cv-zabbix-checks-0.3.tar.gz
...
install -m 0755 -o zabbix -g zabbix userparameters/drbd   userparameters/ipmitool   userparameters/pacemaker   userparameters/perc   userparameters/smcli $RPM_BUILD_ROOT/var/lib/zabbix/userparameters/
install -m 0755 -d $RPM_BUILD_ROOT/etc/zabbix/zabbix_agentd.d/
install -m 0755 -o zabbix -g zabbix zabbix_agentd.d/userparameter_drbd.conf   zabbix_agentd.d/userparameter_ipmi.conf   zabbix_agentd.d/userparameter_pacemaker.conf   zabbix_agentd.d/userparameter_perc.conf   zabbix_agentd.d/userparameter_smcli.conf  $RPM_BUILD_ROOT/etc/zabbix/zabbix_agentd.d/
...
install -m 0644 templates/apc_inrow_cooling.xml templates/drbd.xml templates/ipmitool.xml templates/pacemaker.xml templates/perc.xml templates/powervault.xml templates/slurm.xml templates/smcli.xml  $RPM_BUILD_ROOT/usr/lib/zabbix/templates/
...
install -m 0644 externalscripts/check_md_status  externalscripts/slurm $RPM_BUILD_ROOT/usr/lib/zabbix/externalscripts/
