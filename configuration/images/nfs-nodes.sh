...
sharedopts="nfs    defaults,nfsvers=4,ro,rsize=1048576,wsize=1048576,proto=${proto}    0  0"
homeopts="nfs    defaults,nfsvers=4,rw,rsize=1048576,wsize=1048576,proto=${proto}    0  0"
