...
openstack-config --set /etc/nova/nova.conf vnc novncproxy_base_url http://${TRIX_CTRL_IP}:6080/vnc_auto.html
...
echo "export NODE_MGMT_NIC=$COMPUTE_MGMT_NIC" >> /opt/nic
